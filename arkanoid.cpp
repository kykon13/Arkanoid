...
TForm1 *Form1;
        ...
        bool kolizja (TImage* pilka, TImage * cegla)
        {
             if(pilka->Left>=cegla->Left-pilka->Width &&
                ...
                pilka->Top>=cegla->Top-pilka->Width &&
                pilka->Top<=cegla->Top+cegla->Width )
...
void __fastcall TForm1::Timer_pilkaTimer(TObject *Sender)
{
        ...
        }  else if (b->Left > p->Left-b->Width/2 && b->Left+p->Width &&
        ...
        //blok
        if(kolizja(b,Image)&&Image->Visible==true)
        {x=-x; y=-y; Image->Visible=false; do_wygranej--;}
        //blok1
